 ...
 * CellType
 *
 * @ORM\Table(indexes={@ORM\Index(name="cellType_entity_index", columns={"""entityId"""}),@ORM\Index(name="cellType_name_index", columns={"name"}) } )
 * @ORM\Entity(repositoryClass="EtoxMicrome\EntityBundle\Entity\CellTypeRepository")
 */
class CellType
{
    /**
